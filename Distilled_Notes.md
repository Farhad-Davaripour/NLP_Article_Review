...
- [Essential Topics in Natural Language Processing](#essential-topics-in-text-processing-pipeline)
  * [`Tokenization`](#-tokenization-)
  * [`Stop Words`](#-stop-words-)
  * [`Word Normalization`](#-word-normalization-)
  * [`Lemmatization`](#-lemmatization-)
  * [`Part of Speech (POSE)`: This technique classifies the words into the grammatical categories (e.g., verb, noun, etc.) [1]. Using above example:](#-part-of-speech--pose----this-technique-classifies-the-words-into-the-grammatical-categories--eg--verb--noun--etc---1--using-above-example-)
...
## `Tokenization`
 The process of breaking down sentences into individual word also called tokens. This is typically the first step in converting unstructured data into meaningful information [1]. Example:  
...
## `Stop Words`
 This step eliminates the words that do not contribute to the overall meaning of the sentence also called `stop words`. Using above example [1]:  
><pre> Filtered Sentence: ['John', 'decided', 'go', 'New', 'York', 'attend', 'conference', '.']</pre>
## `Word Normalization`
It includes any techniques that reduces the word into it's base or root form. Two techniques employed in word normalization are [1]:
...
## `Part of Speech (POSE)`: This technique classifies the words into the grammatical categories (e.g., verb, noun, etc.) [1]. Using above example:  
><pre> POS tags: [('John', 'NNP'), ('decided', 'VBD'), ('go', 'VB'), ('New', 'NNP'), ('York', 'NNP'), ('attend', 'JJ'), ('conference', 'NN'), ('.', '.')]</pre>
## `Named Entity Recognition (NER)`
This method classifies words into predefined categories such as person, organization, etc [1]. Using above example:  
...
## `N-gram`
It provides a more detailed understanding of context compared to BoW by providing identifying the sequence of n consecutive and their frequency [2]. Example:
...
## `Sentiment Analysis`
Sentiment analysis is a computational technique used to detect and categorize attitudes and opinions in text, applicable at various granularity levels like documents, sentences, or paragraphs. 
